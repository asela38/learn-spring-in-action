...
public class IngredientUtils {
    public static List<Ingredient> getIngredients() {
        List<Ingredient> ingredients = Arrays.asList(
            ...
            Ingredient.builder().id("TMTO").name("Diced Tomatoes").type(Ingredient.Type.VEGGIE).build(),
            Ingredient.builder().id("LETC").name("Lettuce").type(Ingredient.Type.VEGGIE).build(),
